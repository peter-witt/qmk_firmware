...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_TAB,  RAISE,   KC_A,    KC_S,    KC_D,    KC_F,   KC_G,    KC_H,     KC_J,    KC_K,    KC_L,   KC_SCLN, KC_QUOT, KC_BSPC,
    KC_DEL,  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,    KC_N,     KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_UP,   KC_DEL,
  ...
  [_RAISE] = LAYOUT(
    ...
    RESET, _______, _______, _______, _______, _______, _______, _______, _______, KC_UP,   _______,  _______, _______, _______,
    RESET, _______, KC_LSFT, KC_TAB, KC_LALT, KC_LGUI,  KC_RCTL, KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______,
    RESET, _______, _______, _______, _______, _______, _______, KC_END,  KC_DEL,  _______, _______,  _______, _______, _______,
    RESET, _______, _______, _______, _______, _______, LALT(KC_BSPC), _______, _______, _______, _______,  _______, _______, _______
  ),
